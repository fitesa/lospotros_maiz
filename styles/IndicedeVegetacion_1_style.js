...
var style_IndicedeVegetacion_1 = function(feature, resolution){
    ...
    if (value >= 0.086008 && value <= 0.213866) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.213866 && value <= 0.341724) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.341724 && value <= 0.469582) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.469582 && value <= 0.597441) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.597441 && value <= 0.725299) {
            style = [ new ol.style.Style({
